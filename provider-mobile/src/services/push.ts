...
// Alerts that arrive while the app is open still show as a banner, so a new lead is never missed.
...
/** The person switched lead alerts off in More; the app does not re-register until they switch them on. */
