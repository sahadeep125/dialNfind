// Terms and privacy for business accounts, the same text as the business app. The DialNFind team can
// link the authoritative versions from the admin console (terms_url / privacy_url).
...
export const LEGAL_DOCS: Record<LegalDocKey, LegalDoc> = {
  terms: {
    ...
    intro:
      "These terms apply when you list a business on DialNFind and use the DialNFind Business app and website. They are a general summary; the version published by DialNFind is the one that applies.",
    sections: [
      {
