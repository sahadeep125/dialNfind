...
import { BadgeCheck, Bell, CreditCard, Megaphone, MessageSquare, PhoneIncoming, Store } from "lucide-react";
      ...
      <PopoverContent align="end" className="w-[22rem] max-w-[calc(100vw-2rem)] p-0">
        ...
        <ul className="max-h-96 divide-y overflow-y-auto">
          ...
          {data?.notifications.map((n) => {
            ...
            return (
              <li key={n.id} className={cn("flex gap-3 px-4 py-3", !n.isRead && "bg-accent/50")}>
